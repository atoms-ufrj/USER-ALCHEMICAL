...
void PairLJCutSoftcore::compute(int eflag, int vflag)
{
  ...
  double qtmp,xtmp,ytmp,ztmp,delx,dely,delz,evdwl,Ws6inv,fpair;
  double rsq,r2inv,r4,r6,s6,s6inv,forcelj,factor_lj;
  double dEdl_vdwl_ij,evdwlk;
