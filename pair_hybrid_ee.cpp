...
PairHybridEE::PairHybridEE(LAMMPS *lmp) : Pair(lmp),
...
void PairHybridEE::compute(int eflag, int vflag)
{
  int i,j,m,n;
...
void PairHybridEE::compute_inner()
{
  for (int m = 0; m < nstyles; m++)
...
void PairHybridEE::compute_middle()
{
  for (int m = 0; m < nstyles; m++)
...
void PairHybridEE::compute_outer(int eflag, int vflag)
{
  outerflag = 1;
  compute(eflag,vflag);
  outerflag = 0;
...
void PairHybridEE::settings(int narg, char **arg)
{
...
void PairHybridEE::coeff(int narg, char **arg)
{
...
double PairHybridEE::init_one(int i, int j)
{
...
void PairHybridEE::write_restart(FILE *fp)
{
...
void PairHybridEE::read_restart(FILE *fp)
{
  int me = comm->me;
...
double PairHybridEE::single(int i, int j, int itype, int jtype,
...
void PairHybridEE::modify_params(int narg, char **arg)
{
...
void PairHybridEE::modify_special(int m, int narg, char **arg)
{
  double special[4];
  int i;
...
void PairHybridEE::set_special(int m)
{
  int i;
  if (special_lj[m])
...
double * PairHybridEE::save_special()
{
...
void PairHybridEE::restore_special(double *saved)
{
  for (int i = 0; i < 4; ++i) {
...
void *PairHybridEE::extract(const char *str, int &dim)
{
  void *cutptr = NULL;
  void *ptr;
  double cutvalue = 0.0;
...
int PairHybridEE::check_ijtype(int itype, int jtype, char *substyle)
{
  for (int m = 0; m < nmap[itype][jtype]; m++)
...
double PairHybridEE::memory_usage()
{
