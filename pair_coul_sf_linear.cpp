...
PairCoulSFLinear::PairCoulSFLinear(LAMMPS *lmp) : PairAlchemical(lmp)
{
  single_enable = 1;
  self_flag = 0;
}
...
PairCoulSFLinear::~PairCoulSFLinear()
{
...
void PairCoulSFLinear::compute(int eflag, int vflag)
{
...
void PairCoulSFLinear::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairCoulSFLinear::coeff(int narg, char **arg)
{
  if (narg != 2)
...
void PairCoulSFLinear::init_style()
{
  if (!atom->q_flag)
...
double PairCoulSFLinear::init_one(int i, int j)
{
  return cut_coul;
}
...
void PairCoulSFLinear::modify_params(int narg, char **arg)
{
  if (narg == 0)
...
void PairCoulSFLinear::write_restart(FILE *fp)
{
...
void PairCoulSFLinear::read_restart(FILE *fp)
{
...
double PairCoulSFLinear::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairCoulSFLinear::extract(const char *str, int &dim)
{
...
double PairCoulSFLinear::derivative()
{
  return dEdl;
}
